...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "on_test_layout_shapes", function() { return on_test_layout_shapes; });
...
function on_test_new_text_layer(context) {
  ...
  var newText = Object(_models__WEBPACK_IMPORTED_MODULE_0__["newTextLayer"])(textStyle);
  console.log(newText);
...
function one_square(rect, points) {
  var shape1 = Object(_models__WEBPACK_IMPORTED_MODULE_0__["newShape"])('rectangle', rect);
  var shape2 = Object(_models__WEBPACK_IMPORTED_MODULE_0__["newShape"])('rectangle', rect);
...
function on_test_layout_shapes(context) {
  var document = context.document;
  var page = document.currentPage();
  var rect = {
    x: 0,
  ...
  for (var row = 0; row < 10; row += 1) {
    for (var column = 0; column < 10; column += 1) {
      ...
      Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("width", rect.width, layer);
      Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("height", rect.height, layer);
      Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("x", rect.x, layer);
      Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("y", rect.y, layer);

      if (column < 9) {
        Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("name", "0" + (column + 1).toString(), layer);
      } else {
        Object(_models__WEBPACK_IMPORTED_MODULE_0__["setAttribute_forLayer"])("name", "10", layer);
      }
    }
  }
  ...
  layers.forEach(function (layer) {
    ...
    var textLayer = Object(_models__WEBPACK_IMPORTED_MODULE_0__["initTextLayer"])(newText("color_value", '#' + Object(_functions__WEBPACK_IMPORTED_MODULE_1__["getHex_fromLayer"])(layer), layer));
    ...
    textLayer.frame().setY(Object(_models__WEBPACK_IMPORTED_MODULE_0__["getAttribute_fromLayer"])("y", layer) + 60);
  });
}
